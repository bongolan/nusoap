...
class wsdl extends nusoap_base
{
    ...
    public function parseWSDL($wsdl = '')
    {
        ...
        if (isset($wsdl_props['scheme']) && ($wsdl_props['scheme'] == 'http' || $wsdl_props['scheme'] == 'https')) {
            ...
            $wsdl_string = str_replace('http://eapa2.ecconnect.com.au/eap/owi/webservices/ecgw_webservice.cfc', 'https://eapa2.ecconnect.com.au/eap/owi/webservices/ecgw_webservice.cfc', $wsdl_string);
